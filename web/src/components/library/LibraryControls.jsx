...
export function LibraryControls({ explorer, showSorting = true }) {
    return (<section className="library-controls" aria-labelledby="library-controls-title">
      <header className="library-controls-header">
        <div>
          ...
          <p>
            {showSorting
                ? "Filtros e ordenacao mudam apenas esta visualizacao; nenhuma preferencia e salva no repositorio."
                : "Filtros mudam apenas esta visualizacao; a timeline mantem ordem cronologica derivada em runtime."}
          </p>
        </div>
        <strong>
      ...
      <div className="library-filter-grid">
        ...
        {showSorting ? (<label className="library-control-field">
